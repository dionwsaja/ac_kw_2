  ...
  return (
    <section className="max-w-screen-3xl mx-auto mb-2 md:mb-12 pt-16">
      <div className="relative">
        <div className="absolute left-1/2 -translate-x-1/2 -translate-y-3 md:-translate-y-4 md:-translate-x-1/2 lg:-translate-x-1/2 lg:-translate-y-6">
          <div className="flex justify-center bg-black w-[300px] md:w-[500px] items-center mx-auto px-4 lg:w-[800px]">
